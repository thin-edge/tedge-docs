...
const config = {
  ...
  themeConfig:
    ...
    ({
      ...
      announcementBar: {
        id: 'official-2.0.0-release',
        content:
          'New 2.0.0 release 🚀 thin-edge.io is even more powerful than before. New features include flows, custom cloud connections and much more!',
      },
