...
function UserContextForm(props = {}) {
  ...
  const [c8yPassword, setC8yPassword] = useLocalStorage('C8Y_PASSWORD', props.c8yPassword || 'YourTenantPassword');
  useEffect(() => setC8yPassword(c8yPassword), [c8yPassword]);
      ...
      <div className="card" style={{ 'display': showContext ? 'inherit' : 'none' }}>
        <div className="card__body">
          <div className='container'>
            ...
            <div className="row margin--xs" style={showStyle('C8Y_PASSWORD')}>
              <div className="col col--4">
                <label htmlFor="c8y-password">Cumulocity IoT Password</label>
              </div>
              <div className="col col--6">
                <input id="c8y-password" inputMode="text" value={c8yPassword} onChange={(e) => setC8yPassword(e.target.value)}></input>
              </div>
            </div>
